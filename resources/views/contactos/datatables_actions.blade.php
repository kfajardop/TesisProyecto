@can('Ver Contactos')
    <a href="{{ route('contactos.show', $id) }}" data-toggle="tooltip" title="Ver" class='btn btn-sm btn-outline-primary'>
        <i class="fa fa-eye"></i>
    </a>
    @endcan

@can('Editar Contactos')
    <a href="{{ route('contactos.edit', $id) }}" data-toggle="tooltip" title="Editar" class='btn btn-sm btn-outline-warning'>
