@can('Ver Caso  Penal  Etapas')
    <a href="{{ route('casoPenalEtapas.show', $id) }}" data-toggle="tooltip" title="Ver" class='btn btn-sm btn-outline-secondary'>
        <i class="fa fa-eye"></i>
    </a>
    @endcan

@can('Editar Caso  Penal  Etapas')
    <a href="{{ route('casoPenalEtapas.edit', $id) }}" data-toggle="tooltip" title="Editar" class='btn btn-sm btn-outline-info'>
