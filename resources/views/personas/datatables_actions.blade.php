@can('Ver Personas')
    <a href="{{ route('personas.show', $id) }}" data-toggle="tooltip" title="Ver" class='btn btn-sm btn-outline-primary'>
        <i class="fa fa-eye"></i>
    </a>
    @endcan

@can('Editar Personas')
    <a href="{{ route('personas.edit', $id) }}" data-toggle="tooltip" title="Editar" class='btn btn-sm btn-outline-warning'>
