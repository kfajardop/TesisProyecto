...
class DocumentoTipoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('action', function(DocumentoTipo $documentoTipo){
                $id = $documentoTipo->id;
                return view('documento_tipos.datatables_actions',compact('documentoTipo','id'));
            })
    ...
    {
        return 'documento_tipos_datatable_' . time();
    }
}
